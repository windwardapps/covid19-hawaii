...
# About COVID-19 Scenarios Hawaii

COVID-19 Scenarios Hawaii was adapted from the original COVID-19 Scenarios application (see below) to apply Hawaii specific scenario information. 

The adaptation is a combined effort between <LinkExternal url="https://www.hawaiidata.org">Hawaii Data Collaborative</LinkExternal> and <LinkExternal url="https://windwardapps.com">Windward Apps</LinkExternal>.
...
# The people behind COVID-19 Scenarios

This tool was developed at the University of Basel in 
the <LinkExternal url="https://neherlab.org">&nbsp;research group&nbsp;</LinkExternal> of Richard Neher by
